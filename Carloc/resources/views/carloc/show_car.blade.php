            ...
            <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
                <div class="col-md-9 ftco-animate pb-5">
                    <p class="breadcrumbs"><span class="mr-2"><a href="{{ route('index') }}">Acceuil <i
                                    class="fa-solid fa-forward"></i></a></span> <span>Détails de voitures <i
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-12">
                    <div class="car-details">
                        <div class="img rounded" style="background-image: url({{ asset('storage/' . $car->img_path) }});">
                        </div>
                        <div class="text text-center">
                            <span class="subheading">Nom : {{ $car->nom }}</span>
                            <h2>Modèle : {{ $car->Modele }}</h2>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row text-center">
                <div class="col-sm-12 col-md-3 mt-3 mb-3">
                    <div class="d-flex">
                        <i class="fa-solid fa-calendar-days fa-2xl text-primary m-2"></i>
                        <p> Date de cration</p>
                    </div>
                    <div>
                        <p class="text-left ml-5"> {{ $car->date_creation }} </p>
                    </div>
                </div>
                <div class="col-sm-12 col-md-3 mt-3 mb-3">
                    <div class="d-flex">
                        <i class="fa-solid fa-gauge-simple fa-2xl text-primary m-2"></i>
                        <p> Vitesse (Km/h)</p>
                    </div>
                    <div>
                        <p class="text-left ml-5"> {{ $car->vitesse }} </p>
                    </div>
                </div>
                <div class="col-sm-12 col-md-3 mt-3 mb-3">
                    <div class="d-flex">
                        <i class="fa-solid fa-user fa-2xl text-primary m-2 "></i>
                        <p> Nombre de passager (s)</p>
                    </div>
                    <div>
                        <p class="text-left ml-5"> {{ $car->nbre_passagers }} </p>
                    </div>
                </div>
                <div class="col-sm-12 col-md-3 mt-3 mb-3">
                    <div class="d-flex">
                        <i class="fa-solid fa-fan fa-2xl text-primary m-2"></i>
                        <p> Climatisation</p>
                    </div>
                    <div>
            ...
            <div class="d-flex">
                <a href="" class="btn btn-primary m-2" title="Payer">Réserver</a>
